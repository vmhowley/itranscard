         ...
         <div className="max-w-screen mx-auto px-4 py-3 flex justify-between text-white ">
                <div className="flex-1 justify-center flex items-start gap-x-4 sm:items-center">
                    ...
                    <p className="font-medium p-2">
                        {t('Una nueva version de Itranscard ya esta Disponible!')} <a  className="font-semibold underline duration-150 hover:text-primary inline-flex items-center gap-x-1">
                            Learn more
