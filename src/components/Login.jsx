        ...
        <div className="fixed inset-0 z-50 bg-background">
            ...
            <div className="w-full max-w-sm space-y-8 text-gray-600">
                ...
                >
                    ...
                    <button
                        className="w-full px-4 py-2 mt-4 font-medium text-white duration-150 bg-indigo-600 rounded-lg hover:bg-indigo-500 active:bg-indigo-600"
                    >
                        Sign in
                    </button>
                </form>
                <div className="relative">
                    ...
                    <p className="absolute inset-x-0 inline-block px-2 mx-auto text-sm bg-white w-fit -top-2">Or continue with</p>
                </div>
